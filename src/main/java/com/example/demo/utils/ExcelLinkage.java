...
public class ExcelLinkage {
    ...
    // 初始化省份数据
    public List<String> province = new ArrayList<String>(Arrays.asList("湖南",
            "广东"));
    // 初始化数据（湖南的市区）
    public List<String> hnCity = new ArrayList<String>(Arrays.asList("长沙市",
            "邵阳市"));
    // 初始化数据（广东市区）
    public List<String> gdCity = new ArrayList<String>(Arrays.asList("深圳市",
            "广州市"));
...
//        cellStyle.setAlignment(HSSFCellStyle.ALIGN_LEFT);
     ...
     *            数据域的sheet名
     */
    public void creatExcelNameList(HSSFWorkbook workbook, String hideSheetName) {
        Name name;
    ...
    public String getcellColumnFlag(int num) {
        String columFiled = "";
        int chuNum = 0;
        int yuNum = 0;
        if (num >= 1 && num <= 26) {
    ...
    public String doHandle(final int num) {
